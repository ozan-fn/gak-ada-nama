...
export default function DashboardAppHeader() {
  ...
  return (
    <header className="grid h-14 shrink-0 grid-cols-3 items-center border-b border-neutral-200/60 lg:border-none bg-white/80 backdrop-blur-md px-4 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 dark:bg-neutral-900/80 dark:border-neutral-800/60">
      ...
      <div className="flex items-center justify-end gap-2">
        <button type="button" className="relative flex h-8 w-8 items-center justify-center rounded-lg bg-neutral-100/60 text-neutral-600 hover:bg-neutral-200/80 hover:text-neutral-900 transition-colors dark:bg-neutral-800/60 dark:text-neutral-400 dark:hover:bg-neutral-700/80 dark:hover:text-neutral-100">
        ...
        <button type="button" className="flex items-center gap-2 rounded-lg bg-neutral-100/60 px-1.5 py-1 hover:bg-neutral-200/80 transition-colors dark:bg-neutral-800/60 dark:hover:bg-neutral-700/80">
