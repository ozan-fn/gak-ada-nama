...
export function groupNearbyReports(reports: NearbyReportPin[]): NearbyReportPin[][] {
...
export function createReportMarkers(
  ...
  const markers = reportGroups.map((reportGroup) => {
    ...
    markerContainer.style.cssText = 'display: block !important; visibility: visible !important; z-index: 999 !important; pointer-events: auto !important;';
