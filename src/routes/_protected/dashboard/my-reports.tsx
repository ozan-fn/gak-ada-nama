...
import { getMyReportsFn } from "#/lib/reports.functions";
...
> = {
  ...
  "Fasilitas Rusak": { icon: AlertTriangle, className: "bg-amber-50 text-amber-500" },
              ...
              <>
                ...
                <div className="flex flex-col divide-y divide-neutral-100">
                  {filteredReports.map((report) => {
                    ...
                    const categoryData = categoryIconMap[report.category] || categoryIconMap.Lainnya;
